...
**Status:** ready-for-agent — first implementation built, then REVERTED by the driver 2026-08-15.
All three open decisions were RULED ON 2026-08-17 (see `## Comments`); the agent brief at the
bottom of this file is the contract for the next pass. The body below is still accurate EXCEPT
for its two-way file-shape model, corrected by "CORRECTION 1" in `## Comments`.
