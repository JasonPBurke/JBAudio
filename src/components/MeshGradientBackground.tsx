  ...
  return (
    <Svg style={StyleSheet.absoluteFillObject}>
      <Defs>
        ...
        <LinearGradient id="diagonalOverlay" x1="0" y1="0" x2="50%" y2="100%">
          <Stop offset="0" stopColor={gradientColors[0]} stopOpacity="0.15" />
          <Stop offset="0.5" stopColor={gradientColors[2]} stopOpacity="0.1" />
          <Stop offset="1" stopColor={gradientColors[3]} stopOpacity="0.2" />
        </LinearGradient>

        {/* Bottom dark fade — darkest color fading up ~40% from bottom */}
        <LinearGradient id="bottomFade" x1="0" y1="100%" x2="0" y2="0">
          <Stop offset="0" stopColor={gradientColors[3]} stopOpacity="1" />
          <Stop offset="0.25" stopColor={gradientColors[3]} stopOpacity="0.7" />
          <Stop offset="0.4" stopColor={gradientColors[3]} stopOpacity="0" />
        </LinearGradient>
      </Defs>
